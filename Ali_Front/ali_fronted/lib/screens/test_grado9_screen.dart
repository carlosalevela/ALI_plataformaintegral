...
class _TestGrado9PageState extends State<TestGrado9Page> with SingleTickerProviderStateMixin {
  ...
  Future<void> enviarTest() async {
    ...
    if (token == null || _userId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('No se pudo obtener el usuario o token.')),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Error de red al enviar el test.')),
      );
    }
  }
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color:
                                          selected ? primary : Colors.grey.shade700,
                                    ),
                                  ),
                                ],
                              ),
